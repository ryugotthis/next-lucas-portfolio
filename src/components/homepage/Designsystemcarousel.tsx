    ...
    >
      ...
      <div className="relative mt-[32px] w-full">
        ...
        <button
          ...
          className="absolute top-1/2 left-[-16px] z-10 flex h-[40px] w-[40px] -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-[0_4px_16px_rgba(0,0,0,0.15)] md:left-[-20px] md:h-[48px] md:w-[48px]"
        >
          <ChevronLeft className="h-[20px] w-[20px] text-[#0A0832] md:h-[24px] md:w-[24px]" />
        </button>
        ...
        <button
          ...
          className="absolute top-1/2 right-[-16px] z-10 flex h-[40px] w-[40px] -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-[0_4px_16px_rgba(0,0,0,0.15)] md:right-[-20px] md:h-[48px] md:w-[48px]"
        >
          <ChevronRight className="h-[20px] w-[20px] text-[#0A0832] md:h-[24px] md:w-[24px]" />
        </button>
