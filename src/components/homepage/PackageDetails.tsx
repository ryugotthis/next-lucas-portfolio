  ...
  return (
    ...
    >
      ...
      <div className="mt-[20px] flex items-center md:mt-[24px]">
        <div className="flex h-[28px] items-center rounded-[22px] bg-[#0A0832] px-[16px] text-[10px] leading-[10px] text-[#DAD8FF] shadow-[0_0_16px_rgba(112,97,255,0.8)] md:h-[33px] md:px-[20px] md:text-[16px] md:leading-[14px]">
          <p>Seulement 2 places/mois</p>
        </div>
      </div>

      {/* 패키지 카드 */}
      <div className="mt-[32px] w-full max-w-[992px] rounded-[5px] bg-[#F1F3FF] p-[24px] md:mt-[40px] md:px-[20px] lg:p-[24px]">
        {/* 헤더: 패키지명(+밑줄) + 가격 */}
        <div className="flex flex-col gap-[8px] md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <div className="mt-[16px] border-t border-[#D9D9F0] md:mt-[20px] md:w-[700px]" />
          </div>
          ...
          <div className="text-left md:text-right">
            ...
            <p className="text-description text-[11px] leading-[14px] md:text-[14px] md:leading-[16px]">
              Hors taxe
              <br />
              Exonéré de TVA
            </p>
        ...
        <div className="mt-[24px] max-w-[220px] border-t border-[#D9D9F0] md:mt-[32px]" />

        {/* 하단: 옵션 + CTA */}
        <div className="mt-[20px] flex flex-col gap-[20px] md:mt-[24px] md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-description bold mb-[10px] text-[14px] leading-[18px] md:text-[24px] md:leading-[20px]">
              Options
            </p>
            <div className="flex flex-col gap-y-[6px]">
              {options.map((option) => (
                <p
                  key={option.label}
                  className="text-description text-[13px] leading-[18px] md:text-[18px] md:leading-[20px]"
                >
